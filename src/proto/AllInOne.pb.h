...
#ifndef GOOGLE_PROTOBUF_INCLUDED_AllInOne_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_AllInOne_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_AllInOne_2eproto
...
struct TableStruct_AllInOne_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_AllInOne_2eproto;
namespace A0S_proto {
class Enemy;
...
class SDL_Rect final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_AllInOne_2eproto;
};// -------------------------------------------------------------------
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_AllInOne_2eproto_2epb_2eh
