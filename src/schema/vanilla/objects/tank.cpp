// src\schema\vanilla\objects\tank.cpp // Copyright 2025 Alex0vSky (https://github.com/Alex0vSky), Copyright 2015-2021 (https://github.com/KrystianKaluzny/Tanks)
#include "tank.h"
#include "appconfig.h"
...
void Tank::update(Uint32 dt)
{
    ...
    bullets.erase(std::remove_if(bullets.begin(), bullets.end(), [](Bullet&b){ return b.to_erase;}), bullets.end());
}
