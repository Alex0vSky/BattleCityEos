// src\schema\cista\objects\tank.cpp // Copyright 2024 Alex0vSky (https://github.com/Alex0vSky), Copyright 2015-2021 (https://github.com/KrystianKaluzny/Tanks)
#include "tank.h"
#include "appconfig.h"
...
void Tank::draw()
{
    ...
    if(testFlag(TankStateFlag::TSF_SHIELD) ) m_shield.draw();
